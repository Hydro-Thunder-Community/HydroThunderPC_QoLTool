...
**This project does NOT use AI in any way, shape, or form. And it will stay that way. Research, debugging, programing, and testing for every patch is all 100% done by hand.**
