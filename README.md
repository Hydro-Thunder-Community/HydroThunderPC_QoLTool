...
A program created and written in Game Maker 8.2 by AxlThunder, to address issues in the PC port of Hydro Thunder, as well as introduce some quality of life improvements.
...
**This project does NOT use AI in any way, shape, or form. And it will stay that way. Research, reverse engineering, debugging, programming, and testing for every patch is all 100% done by hand.**
